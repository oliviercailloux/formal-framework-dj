...
\title{A formal framework for deliberated judgment%
	\thanks{This is the postprint version of an article to appear in Theory and Decision.}%
	%The text is identical to the one of the version to appear, except for three minor wording modifications due to page layout.%
}
